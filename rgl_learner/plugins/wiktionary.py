...
params = {
  'positive': ('Posit', 'Degree'),
  'comparative': ('Compar', 'Degree'),
  'superlative': ('Superl', 'Degree'),
  ...
  'future-perfect': ('FutPerfect','Tense'),
  'active': ('Active','Voice'),
  ...
  "infinitive-aorist": ("VNonFinite", "NonFinite"),
  "vpres": ("VPres",("Number","Person","Voice","Aspect"),"VForm"),
  "vpast": ("VPast",("Number","Person","Voice","Aspect"),"VForm"),
  "vnonfinite": ("VNonFinite",("Voice",),"VForm"),
  "vimperative": ("VImperative",("Aspect","Number","Voice"),"VForm"),
  "vgerund": ("VGerund","VForm"),
  "vparticiple": ("Participle","VForm")
}
